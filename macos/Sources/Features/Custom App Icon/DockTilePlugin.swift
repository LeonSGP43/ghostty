...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.sgpleon.ghodex.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.sgpleon.ghodex")
    #endif
